...
-- 与 BiaoGe/BGLite 共用 BG 命名空间，禁止重置
BG = BG or {}

-- 独立资源路径（不依赖 BiaoGe 插件目录；Media 子目录可选，缺失时用暴雪内置资源）
ns.MediaRoot = "Interface\\AddOns\\TitanCharOverview\\Media\\"
ns.MediaIcon = {
    logo = "Interface\\Icons\\INV_Misc_Book_09",
    BOX = "Interface\\Icons\\INV_Misc_Bag_08",
    DD = "Interface\\Buttons\\UI-SpellbookIcon-NextPage-Up",
}
