...
do --简体说明书
    ...
    ns.updateText_before = {
        "|cff00FF00" ..[[8月21日更新v2.3.5]] ,
        [[-角色总览：增加显示"其他装备部位"（需在设置里自行勾选部位）]] ,
        [[-角色总览设置：自定义排序界面新增服务器选择，可直接修改各服务器的角色排序]],
        [[-角色总览：使用自定义排序时，其他服务器的角色也会使用自定义排序]],
        [[-角色总览：修复了使用横向布局2时，其他服务器角色的货币总览与角色顺序不一致的问题]],
        [[-历史账单汇总：增加"物品汇总"]] ,
        [[-<时光服>增加奥杜尔表格]] ,
        [[-<TBC>增加海山黑庙表格]] ,
        " ",
        "|cff00FF00" ..[[8月19日更新v2.3.4]] ,
        [[-角色总览：增加显示"武器"]] ,
        [[-修复了历史账单汇总的合计工资错误的问题（需手动重新汇总一次）]] ,
        [[-<MOP>优化奥格表格布局，使得罚款显示空间更大]] ,
        " " ,
        "|cff00FF00" ..[[8月15日更新v2.3.3]] ,
        [[-自动拍卖：自动出价不再因限流而中途哑火]] ,
        [[-商品总览现在可以在设置-其他功能里禁用了]],
        [[-<时光服>更新P5周常任务]],
        " " ,
        "|cff00FF00" ..[[8月13日更新v2.3.2]] ,
        [[-<时光/MOP>增加随机本记录（该模块默认禁用，入口在表格底部）]] ,
        [[-<时光服>角色总览：当你的橙武过多时，不再入侵到旁边的框架]] ,
        [[-<正式服>增加烈毒之渊表格]],
        [[-表格设置：增加"表格底部标签自由排序"]],
        [[-修复了支出模版导入时可能会缺少内容的问题]],
        " " ,
        "|cff00FF00" .. [[8月9日更新v2.3.1]],
        [[-<时光服>更新祖阿曼掉落]],
        [[-<MOP>更新奥格站位图材质]],
        " ",
        "|cff00FF00" .. [[8月8日更新v2.3.0]],
        [[-修复了第二代匿名拍卖有时出现拍卖结果不一致和无法出价的问题]],
    }
end
...
do
    ...
    L["BiaoGe插件提醒：由于暴雪对插件UI数量的限制，本插件无法在硬核服务器使用，请你自行禁用。"] = true
    L["显示悬浮框"] = true
    L["悬浮框缩放"] = true
    L["调整悬浮框UI的大小。"] = true
    L["悬浮框层级"] = true
    L["|cff808080流拍价："] = true
    L["也有可能是你的WCL插件缺少本服务器数据包。鼠标指向一个玩家时，如果不显示WCL数据，说明就是上述问题。此问题与BiaoGe插件无关。"] = true
    L["保存"] = true
    L["分享"] = true
    L["导出"] = true
    L["应用"] = true
    ...
    L['流拍装备卖店总价：%s金'] = true
    L["搜索装备/买家/金额"] = true
    L["团长使用教程：输入命令/ai打开BiaoGeAI插件，点击一键安排，再点击发送。"] = true
    L["团长使用教程：输入命令/tj打开TuanJian插件，点击一键安排，再点击发送。"] = true
    L["团长需使用TuanJian插件才能发送站位图，该插件可在各大插件平台免费下载。"] = true
    L["|cffff0000（BiaoGeLib插件被你禁用了）"] = true
    ...
    L["由于你的部分角色同时存在于多个子战网，导致同步异常。请分别登录各子账号后重开 /tco 刷新数据。"] = true
    ...
    L["BiaoGeAccounts插件被你禁用了，导致无法显示全战网角色"] = true
    L["自动点击交易按钮"] = true
    L["简化活动列表"] = true
    ...
    L["正在修改%s|r的备注"] = true
    L["文本使用职业颜色："] = true
    L["使用方法：/tco，把角色总览面板固定，然后鼠标点击角色对应的备注栏即可修改备注。"] = true
    L["升级道具"] = true
    L["正义奖章"] = true
    L["请给团长个评价吧！"] = true
    L["交易中:"] = true
    ...
    L["禁用该模块"] = true
    L["启用该模块"] = true
    L["该模块已被禁用，右下角可以启用该模块"] = true
    L["该模块已被禁用，右下角可以启用模块"] = true
    L["该模块已禁用（重载后生效）"] = true
    L["该模块已启用（重载后生效）"] = true
    L["开启该模块"] = true
    L["装备："] = true
    ...
    L["显示其他装备部位"] = true
    L["选择部位"] = true
    L["在饰品列后面增加显示一个装备列，可自由选择要显示的装备部位。"] = true
    L["在饰品后面增加显示其他装备部位。"] = true
    L["满级"] = true
    L["完成"] = true
    L["巨龙"] = true
    L["T13套"] = true
    ...
    L["实际交易：%s"] = true
    L["角色数据错误"] = true
    L["你部分角色存在错误，请你/tco，然后鼠标悬停在有错误的角色上，会显示解决办法。"] = true
    L["插件过期提醒"] = true
    ...
    L["匿名模式对你无效"] = true
    L["提示"] = true
    L["如果多次点击出价都没有反应，建议你尝试多加一手价格后再出价。"] = true
    L["部分团员的BiaoGe版本低于%s，不建议你使用匿名模式，否则会出现拍卖结果不一致的情况。"] = true
    ...
    L["拖动标签调整顺序"] = true
    L["恢复默认顺序"] = true
    L["排序列表里记录着来自同步模块中其他子账号的角色，有一些角色可能已经不存在。"] = true
    ...
    L["角色配置"] = true
    L["点击角色名字：使面板固定显示"] = true
    L["没有该角色的装备数据。"] = true
    L["请打开同步软件并登录一次该角色。"] = true
    L["请登录一次该角色。"] = true
    L["缺少附魔！"] = true
    L["缺少宝石！"] = true
    L["装等："] = true
    L["子账号："] = true
    L["全部子账号"] = true
    L["|cffff0000（角色存在重复情况，会导致同步失效和数据错误。请登录上述账号，表格设置-角色配置-删除角色。）|r"] = true
    L["一键显示"] = true
    ...
    L["调整装备记录通知、交易通知和减伤链进度条的位置。"] = "调整装备记录通知、交易通知和减伤链进度条的位置。"
    L["快捷命令：/BGM"] = true
    L["快捷命令：/bgmap 或 /tjmap"] = true
    L["把当前表格保存至历史表格。"] = true
    ...
    L["（点击选择装备，SHIFT+点击发送装备，CTRL+点击查看该部位的其他可选装备）"] = true
...
do -- 批量邮寄
    ...
    L["特定字符:"] = true
    L["实际效果:"] = true
    L[ [[比如：在主题里输入"工资{A}金"，在邮寄金额里输入"2000"，那么实际发送的主题是"工资2000金"。]] ] = true
    L["邮寄记录"] = true
    L["实际发送效果："] = true
    L["邮寄人数："] = true
    L["邮寄金额："] = true
...
do
    ...
    L['|cff00BFFFBiaoGe：|r你的职业对应兑换的装备'] = true
    L['不在团队里。'] = true
    L['表格没有历史成员名单。'] = true
    ...
    L['|cff00BFFFBiaoGe：|r你的职业兑换后的装备'] = true
    L['|cffFFD100物品等级'] = true
    L['BiaoGe：你的职业兑换后的装备'] = true
    L['BiaoGe：兑换后的装备'] = true
    ...
    L["出价设为："] = true
    L["心理价格："] = true
    L["心理价格已满，请先删除一条心理价格。"] = true
    L["%s的心理价格已设为：%s"] = true
    L["提示：CTRL+ALT+点击表格装备，可预设心理价格。"] = true
    L["提示：ALT+右键点击表格装备，可添加心理价格。"] = true
    L["全部启用"] = true
    L["全部禁用"] = true
    L["全部清空"] = true
    L["预设心理价格"] = true
    ...
    L["（需要第二代拍卖）"] = true
    L["已暂停"] = true
    L['需要团员的BiaoGe版本高于v2.0.0，否则团员无法看见拍卖框。'] = true
    L["正在核对"] = true
    L["忽略战网绑定"] = true
    L["忽略战网绑定的装备"] = true
    ...
    L['向团长申请重拍'] = true
    L['提醒团长拍卖'] = true
    L['团长的BiaoGe版本高于v2.0.7时才能收到你的请求。'] = true
    ...
    L["忽略华丽制皮（需重载）"] = true
    L["忽略帝王丝绸（需重载）"] = true
    L["忽略贾德的特制能量源（需重载）"] = true
    L["已开始自动出价：%s %s。"] = true
    L['团长的BiaoGe版本高于%s时才能收到你的请求。'] = true
    L["拍重"] = true
    L["以下装备可能存在重复拍卖："] = true
    -- 历史表格汇总
    L["保存表格时，自动进行汇总"] = true
    ...
    -- 预设价格
    L["%s件"] = true
    L["10人|cff00BFFF普通"] = true
    L["10人|cffff0000英雄"] = true
    L["25人|cff00BFFF普通"] = true
    L["25人|cffff0000英雄"] = true
    L["ALT+%s点击表格/背包/聊天框装备时，直接按你的预设价开拍。"] = true
    L["ALT+点击：按预设价全部开拍"] = true
    L["把当前选择的%s件装备设置为该起拍价。"] = true
    L["把当前选择的%s件装备设置为该起拍语。"] = true
    L["把序号%s-%s的装备设置为该起拍价。"] = true
    L["把序号%s-%s的装备设置为该起拍语。"] = true
    L["把一共%s件装备设置为该起拍价。"] = true
    L["把一共%s件装备设置为该起拍语。"] = true
    L["绑定类型："] = true
    L["不绑定"] = true
    L["代码错误！识别失败！"] = true
    L["导出价格"] = true
    ...
    L["困难"] = true
    L["史诗"] = true
    L["没有符合当前过滤条件的装备。"] = true
    L["没有预设价"] = true
    L["普通"] = true
    L["起拍价"] = true
    L["起拍语"] = true
    L["起拍语："] = true
    L["起拍语会显示在你拍卖一个装备的团队消息后面。"] = true
    L["设置本页起拍价"] = true
    L["设置本页起拍价："] = true
    L["设置本页起拍语"] = true
    L["设置本页起拍语："] = true
    ...
    L["有职业限制"] = true
    L["预设价格"] = true
    L["预设价格导入成功：%s，一共导入%s个价格。"] = true
    L["预设起拍价："] = true
    L["预设起拍价：|cffffffff"] = true
    L["预设起拍语：|cffffffff"] = true
    L["职业限制："] = true
    L["装备绑定"] = true
    L["装备部位："] = true
    L["装备等级："] = true
    ...
    L["装备属性：\n（单选）"] = true
    L["开拍"] = true
    L["对拾取框里有预设价格的装备发起拍卖。"] = true
    L["%s%s|cffffffff(%s)|r |cffFFD100起拍价:%s|r"] = true
    L["点击后以下装备将发起拍卖："] = true
    L["拾取框里没有预设价格的装备。"] = true
    L["在BiaoGe底部预设价格标签里设价格。"] = true
    L["成功导入%d个模版。"] = true
    L["打开支出模版菜单"] = true
    L["导出模版"] = true
    L["导入"] = true
    ...
    L["支出项"] = true
    L["合并罚款"] = true
    L["把相同玩家的多项罚款合并为一项，罚款内容、罚款金额和欠款都会合并一起。"] = true
    L["清空罚款"] = true
    L["打开罚款菜单"] = true
    L["确定清空全部罚款？"] = true
end
...
do -- 进组欢迎语
    ...
    L["是"] = "是"
    L["否"] = "否"
    L["正在更改\"%s\"的名字"] = "正在更改\"%s\"的名字"
    L["进组欢迎语"] = "进组欢迎语"
    L["启用进组欢迎语"] = "启用进组欢迎语"
    L["启用进组欢迎语（生效中）"] = "启用进组欢迎语（生效中）"
    L["启用进组欢迎语（需要创建集结号活动才生效）"] = "启用进组欢迎语（需要创建集结号活动才生效）"
    L["当有人进组时，自动密语对方。"] = "当有人进组时，自动密语对方。"
    L["当有人进组时，自动密语对方。一个输入框为一条密语。"] = "当有人进组时，自动密语对方。一个输入框为一条密语。"
    L["点击黄色齿轮修改密语内容。"] = "点击黄色齿轮修改密语内容。"
    L["发送频道：密语"] = "发送频道：密语"
    L["发送频道：团队"] = "发送频道：团队"
    L["屏蔽欢迎语"] = "屏蔽欢迎语"
    L["在聊天框不显示你发送的欢迎语，避免刷屏。但实际上欢迎语已经发送给对方，对方能看到。"] = "在聊天框不显示你发送的欢迎语，避免刷屏。但实际上欢迎语已经发送给对方，对方能看到。"
    L["启用该消息"] = "启用该消息"
    L["分金规则："] = "分金规则："
    L["拍卖规则："] = "拍卖规则："
    L["模版一"] = "模版一"
    ...
    L["模版%s"] = "模版%s"
    L["模版改名"] = "模版改名"
    L["开组宝库时，不会发送欢迎语。"] = "开组宝库时，不会发送欢迎语。"
    L["关键词自动发YY"] = "关键词自动发YY"
    L["启用关键词自动发YY"] = "启用关键词自动发YY"
    L["当我是团长时生效"] = "当我是团长时生效"
    L["当我是助理时生效"] = "当我是助理时生效"
    L["当团队频道有人打字\"YY\"(不分大小写)时，自动发送你的YY号。"] = "当团队频道有人打字\"YY\"(不分大小写)时，自动发送你的YY号。"
end
...
do -- 减伤链接收器
    ...
    L["减伤链提醒"] = "减伤链提醒"
    L["启用减伤链提醒"] = "启用减伤链提醒"
    L["启用后接收TuanJian团长发送的减伤链；关闭后不显示进度条、不播放语音，也不发送团长密语提醒。"] = "启用后接收TuanJian团长发送的减伤链；关闭后不显示进度条、不播放语音，也不发送团长密语提醒。"
    L["减伤链语音提醒"] = "减伤链语音提醒"
    L["当减伤链安排到你时，播放技能准备和交减伤技能语音。"] = "当减伤链安排到你时，播放技能准备和交减伤技能语音。"
    L["团长密语提醒"] = "团长密语提醒"
    L["当你是减伤链发送者时，在倒数5秒时给相应团员发送密语提醒。"] = "当你是减伤链发送者时，在倒数5秒时给相应团员发送密语提醒。"
    L["当你是减伤链发送者时，在施放前密语被安排的玩家。"] = "当你是减伤链发送者时，在施放前密语被安排的玩家。"
    L["预览减伤链进度条"] = "预览减伤链进度条"
    L["战斗中无法修改减伤链选项"] = "战斗中无法修改减伤链选项"
    L["显示谁的减伤"] = "显示谁的减伤"
    L["显示谁的减伤："] = "显示谁的减伤："
    L["团长看全部，团员看自己"] = "团长看全部，团员看自己"
    L["当我是团长/助理时，显示所有人的减伤，否则仅显示我的减伤"] = "当我是团长/助理时，显示所有人的减伤，否则仅显示我的减伤"
    L["当我是团长/助理时显示所有人的减伤，否则仅显示我的减伤"] = "当我是团长/助理时显示所有人的减伤，否则仅显示我的减伤"
    L["显示所有人的减伤"] = "显示所有人的减伤"
    L["仅显示我的减伤"] = "仅显示我的减伤"
    L["减伤链提前显示时间"] = "减伤链提前显示时间"
    L["只在进入设定的最后若干秒时显示减伤链进度条。"] = "只在进入设定的最后若干秒时显示减伤链进度条。"
    L["提前显示时间（秒）"] = "提前显示时间（秒）"
    L["减伤链进度条缩放"] = "减伤链进度条缩放"
    L["调整减伤链进度条的大小。"] = "调整减伤链进度条的大小。"
    L["玩家A"] = "玩家A"
    L["（测试）"] = "（测试）"
    L["你"] = "你"
    L["现在"] = "现在"
    ...
    L["技能准备"] = "技能准备"
    L["交减伤技能"] = "交减伤技能"
    L["提醒：你需立刻施放%s"] = "提醒：你需立刻施放%s"
    L["提醒：%s秒后你需施放%s"] = "提醒：%s秒后你需施放%s"
end

do -- Random dungeon records
    L["%s：%s-%s（%s）"] = "%s：%s-%s（%s）"
    L["%s：%s级%s%s%s"] = "%s：%s级%s%s%s"
    L["（经验%s）"] = "（经验%s）"
    L["（用时%s）"] = "（用时%s）"
    L["，经验%s"] = "，经验%s"
    L["|cff808080%s|r |cff%s%s%s：%s|r"] = "|cff808080%s|r |cff%s%s%s：%s|r"
    L["DPS太低"] = "DPS太低"
    L["本次副本已完成，用时%s%s。"] = "本次副本已完成，用时%s%s。"
    L["本次副本已完成。"] = "本次副本已完成。"
    L["比如我是板甲职业，会自动贪婪锁甲、皮甲、布甲装备。"] = "比如我是板甲职业，会自动贪婪锁甲、皮甲、布甲装备。"
    L["冰冻宝珠"] = "冰冻宝珠"
    L["队员信息如下："] = "队员信息如下："
    L["队长发起排本时，会弹窗让你选择职责，勾选后不再弹窗并自动确认。"] = "队长发起排本时，会弹窗让你选择职责，勾选后不再弹窗并自动确认。"
    L["对投票确认框的玩家名字增加职业颜色，方便辨认。"] = "对投票确认框的玩家名字增加职业颜色，方便辨认。"
    L["该功能仅对护甲装备有效，武器是无效的。"] = "该功能仅对护甲装备有效，武器是无效的。"
    L["该角色没有随机本记录。"] = "该角色没有随机本记录。"
    L["告诉"] = "告诉"
    L["划水/挂机"] = "划水/挂机"
    L["混乱宝珠"] = "混乱宝珠"
    L["来自"] = "来自"
    L["聊天记录"] = "聊天记录"
    L["另外也会贪婪有职业限制但你不能用的装备，比如你不能用的套装兑换物。"] = "另外也会贪婪有职业限制但你不能用的装备，比如你不能用的套装兑换物。"
    L["奶不住"] = "奶不住"
    L["排本时，小地图的眼睛图标会显示所有职责的平均排队时长，了解什么职责最紧缺。"] = "排本时，小地图的眼睛图标会显示所有职责的平均排队时长，了解什么职责最紧缺。"
    L["平均等待时长"] = "平均等待时长"
    L["全需狗"] = "全需狗"
    L["确认删除%s的随机本记录？"] = "确认删除%s的随机本记录？"
    L["输出："] = "输出："
    L["随机本记录"] = "随机本记录"
    L["太脆抗不住"] = "太脆抗不住"
    L["坦克："] = "坦克："
    L["投票确认框玩家上色"] = "投票确认框玩家上色"
    L["显示全职责的平均排队时长"] = "显示全职责的平均排队时长"
    L["一键填写踢人理由"] = "一键填写踢人理由"
    L["已开启绿装或蓝装自动贪婪功能。如需取消，可在表格右下角随机本记录里取消。"] = "已开启绿装或蓝装自动贪婪功能。如需取消，可在表格右下角随机本记录里取消。"
    L["已删除%s的随机本记录。"] = "已删除%s的随机本记录。"
    L["有人发起了一个将%s从队伍中移出的投票。"] = "有人发起了一个将%s从队伍中移出的投票。"
    L["有人发起了一个将%s从队伍中移出的投票。理由为：%s"] = "有人发起了一个将%s从队伍中移出的投票。理由为：%s"
    L["在5人本自动把坦克标记为"] = "在5人本自动把坦克标记为"
    L["在5人本自动把治疗标记为"] = "在5人本自动把治疗标记为"
    L["在5人本自动贪婪不可用的护甲装备"] = "在5人本自动贪婪不可用的护甲装备"
    L["在5人本自动贪婪蓝装"] = "在5人本自动贪婪蓝装"
    L["在5人本自动贪婪绿装"] = "在5人本自动贪婪绿装"
    L["在5人本自动需求"] = "在5人本自动需求"
    L["在你发起投票踢人时，一键填写踢人理由。"] = "在你发起投票踢人时，一键填写踢人理由。"
    L["在自己头像的菜单里增加离开副本按钮"] = "在自己头像的菜单里增加离开副本按钮"
    L["治疗："] = "治疗："
    L["装备roll点明细"] = "装备roll点明细"
    L["组队排本的职责确认框自动确认"] = "组队排本的职责确认框自动确认"
end
